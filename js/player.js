...
class Player {
    constructor(jugador, p) {
        this.points = 0;
        this.name = jugador;
        if(jugador ==='player2'){
            this.jugadorSprite = p.createSprite(1150, 150, PLAYER_ANCHO, PLAYER_ALTO);
            ...
            this.jugadorSprite.mirrorX(-1);
        }else{
            this.jugadorSprite = p.createSprite(150, 150, PLAYER_ANCHO, PLAYER_ALTO);
    ...
    playerInici(jugador){
        if(jugador ==='player2'){
            this.jugadorSprite.position.x = 1100;
            this.jugadorSprite.position.y = 400;
        }else{
            this.jugadorSprite.position.x = 150;
            this.jugadorSprite.position.y = 400;
        }
    }
